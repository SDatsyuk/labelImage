...
class MainWindow(QMainWindow, WindowMixin):
    ...
    def __init__(self, defaultFilename=None, defaultPrefdefClassFile=None, defaultSaveDir=None):
        ...
        delete = action('Delete\nRectBox', self.deleteSelectedShape,
                        'Ctrl+P', 'delete', u'Delete', enabled=False)
        delete_image = action("Delete Image", self.deleteImage, 'Delete', 'deleteImg', u"Delete current image", enabled=True)
        ...
        labelMenu = QMenu()
        addActions(labelMenu, (edit, delete, delete_image))
        ...
        self.actions = struct(save=save, save_format=save_format, saveAs=saveAs, open=open, close=close, resetAll = resetAll,
                              lineColor=color1, create=create, delete=delete, delete_image=delete_image, edit=edit, copy=copy,
                              ...
                              beginner=(), advanced=(),
                              editMenu=(edit, copy, delete, delete_image,
                                        None, color1, self.drawSquaresOption),
                              beginnerContext=(create, edit, copy, delete, delete_image),
                              advancedContext=(createMode, editMode, edit, copy,
                                               delete, delete_image, shapeLineColor, shapeFillColor),
                              onLoadActive=(
        ...
        self.actions.beginner = (
            open, opendir, changeSavedir, openNextImg, openPrevImg, verify, save, save_format, None, create, copy, delete, delete_image, None,
    ...
    def addLabel(self, shape):
        if isinstance(shape, list):
            for s in shape:
                ...
                # print(s.paintLabel)
                item = HashableQListWidgetItem(s.label)
                item.setFlags(item.flags() | Qt.ItemIsUserCheckable)
                item.setCheckState(Qt.Checked)
                item.setBackground(generateColorByText(s.label))
    ...
    def deleteImageDialog(self):
        yes, no = QMessageBox.Yes, QMessageBox.No
        msg = u"Delete this image?"
        return yes == QMessageBox.warning(self, u"Delete image", msg, yes | no)
